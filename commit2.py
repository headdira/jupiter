...
SOURCE_FILE = r"C:\Users\Loovi\Documents\jupiter-v2\data\enriched_devices_data.json"
DEST_FILE = os.path.join(REPO_DIR, "enriched_devices_data.json")  # Agora vai direto na raiz do repositório

# Mensagem do commit
COMMIT_MESSAGE = "Atualizar enriched_devices_data.json automaticamente via script"
...
def push_file_to_github():
    ...
    run_git_command("git add enriched_devices_data.json", cwd=REPO_DIR)
